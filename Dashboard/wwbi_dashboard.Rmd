...
css: "C:/Users/WB501238/Documents/GitHub/Worldwide-Bureaucracy-Indicators/Dashboard/styles.css"
params:
...
# 1 Set Initial configs ===============================================================
  ...
  # Load full data set
  wwbi <- read.csv(file.path(FolderPath,"wwbi1109.csv"), header = T,
                   stringsAsFactors = F)
...
# ================================================================================= #
  ...
  # 2.1 Test if Wage bill section will be displayed and save that in an object ------
    ...
    wb_gdp <- !is.na(wwbi$wage_gdp[wwbi$countryname == "Ethiopia"])
    
    # 2.1.2 Is the second plot going to be created? ----------------------------------
    wb_exp <- !is.na(wwbi$wage_x[wwbi$countryname == "Ethiopia"])
